...
See `GENERATE-EXAMPLE.md` in this directory for the repeatable process behind every run
here, including what's worth stressing that existing runs don't already cover.
